...
public class OrderedList_inArraySlots
    ...
    private void swap(ArrayList<Integer> challengers, int idx1, int idx2) {
        Integer temp = challengers.get(idx2);
    ...
    public OrderedList_inArraySlots
        ...
        for (int i = 0; i < unordered.size(); i++) {
            // System.out.println(i + ", " + champIndex(unordered, i) + ", " + unordered);
...
//          );
    ...
    private int champIndex( ArrayList<Integer> challengers, int start) {
        ...
        for (int i = start; i < challengers.size(); i++) {
            if (challengers.get(i) != null && challengers.get(i) < minVal) {
